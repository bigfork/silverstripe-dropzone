...
A [Dropzone.js](https://doc.dropzone.deltablot.app/) field for Silverstripe 6 — designed to be used
on the frontend, not in the CMS.
...
Use [`silverstripe/asset-admin`](https://github.com/silverstripe/silverstripe-asset-admin)'s
`UploadField` for CMS edit forms — that's what it's for.
